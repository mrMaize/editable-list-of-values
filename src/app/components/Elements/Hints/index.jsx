  ...
  render() {
    return (
      <div>
        ...
        />
        <button
          onClick={this.onClickGenerateSet}
        ...
        <p>
          2. It is shown 20 rows per page. Use navigation bar bellow the list to
          change the page.
        </p>

        <p>
          3. It is possible to delete the line. Just click the red button says
          "Delete" next to the row you want to blow away.
        </p>

        <p>
          4. To edit row click the button says "Edit". Then you'll jump into the
          edit mode. Change data in the row and click green save button.{" "}
        </p>

        <p>
          5. You can filter the whole data set. Enter something into input
          bellow{" "}
          <u>
            <b>Label</b>
          </u>{" "}
          ...
          and press Enter or click blue button says "Search". If nothing is
          shown, clear all inputs and hit Enter again.
        </p>

        <p>
          6. You can sort data by column. Click the "Label" once or twice to see
          the result.
        </p>

        <p>
          7. Finally, you can add new data to the end of the list. Put values
          into field bellow and click the button says "Add"
        </p>
